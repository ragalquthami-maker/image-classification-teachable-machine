...
- keras_model.h5: The trained image classification model, exported from Teachable Machine in TensorFlow → Keras format.
- labels.txt: Text file containing the class names (Earphones, Headphones).
