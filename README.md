...
- [keras_model.h5](keras_model.h5): The trained image classification model, exported from Teachable Machine in TensorFlow → Keras format.
- [labels.txt](labels.txt): Text file containing the class names (Earphones, Headphones).
...
- [prediction_result.png](prediction_result.png): Screenshot of the script's output after running a prediction.
